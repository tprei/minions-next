import type { SqliteMigration } from "./migration.js";

export const hostMigrations = Object.freeze([
  Object.freeze({
    version: 1,
    name: "domain_state",
    checksum: "7d4a1671683561e0d731ec532d73d4ed95c60a5850f4a5943cb1e739c540cead",
...
`,
  ...
  Object.freeze({
    ...
    checksum: "68816859d07c3e547b512528825a34a98607f6922159ed0443589ffa62e168a4",
    sql: `CREATE TABLE content_blobs (
...
`,
  ...
  Object.freeze({
    ...
    checksum: "d67ccca75f23bf79605196f33391fa19656eff6183bf1b41fdc351976f7ddf10",
    sql: `CREATE TABLE repository_registrations (
...
`,
  ...
  Object.freeze({
    version: 4,
    name: "plan_foundation",
    checksum: "cfc111faf78effc03cafd99068016625afabf28d024c42717a27d7aecf11d002",
    sql: `CREATE TABLE tree_budgets (
...
`,
  ...
  Object.freeze({
    ...
    checksum: "9f25b8abd7bcf8e200536f4db27474d48c66b0fbf746b08f610003db794117b0",
    sql: `CREATE TEMP TABLE harness_contract_legacy_guard (
...
`,
  ...
  Object.freeze({
    ...
    checksum: "c24931e8c4211782717aeddae06300783acfb65e3997981b9677c5e5e4b5f80b",
    sql: `CREATE TABLE node_scheduler_fences (
  node_id TEXT PRIMARY KEY CHECK (length(node_id) = 36),
...
`,
  ...
  Object.freeze({
    version: 7,
    name: "durable_steering",
    checksum: "804dc3a213db14f1b6b74aab04bfb2d2a3e20f27c06f4dc70b8afb298422121f",
    sql: `CREATE TABLE node_command_sequences (
  node_id TEXT PRIMARY KEY CHECK (length(node_id) = 36),
...
`,
  ...
  Object.freeze({
    version: 8,
    name: "artifacts_outcomes",
    checksum: "25b3d19bed959935a4b3278967070621311bf71a2341082ef921c9c79861d774",
    sql: `CREATE TABLE node_outcome_records (
  node_id TEXT PRIMARY KEY CHECK (length(node_id) = 36),
...
`,
  ...
  Object.freeze({
    version: 9,
    name: "git_workspaces",
    checksum: "908a944b9373b887ff81593ccced426e9b5bab300441efacbffa96ceb5dedffc",
    sql: `CREATE TABLE workspace_bindings_v9 (
  attempt_id TEXT PRIMARY KEY CHECK (length(attempt_id) = 36),
  node_id TEXT NOT NULL CHECK (length(node_id) = 36),
  tree_id TEXT NOT NULL CHECK (length(tree_id) = 36),
  repository_id TEXT NOT NULL CHECK (length(repository_id) = 36),
...
`,
  ...
  Object.freeze({
    version: 12,
    name: "gate_receipts",
    checksum: "def5debde4bc327f964b57d90e0b2201f15e575e47c73923e413e1c17d8bd7ea",
    sql: `CREATE TABLE gate_receipts (
...
`,
  ...
  Object.freeze({
    version: 13,
    name: "vcs_change_bindings",
    checksum: "f88c127b757d1aa8c8726baad353eae7f02fbc909f4b97542942cbed60609ff2",
    sql: `CREATE TABLE vcs_change_bindings (
  tree_id TEXT NOT NULL CHECK (length(tree_id) = 36),
  node_id TEXT NOT NULL CHECK (length(node_id) = 36),
...
`,
  ...
  Object.freeze({
    version: 14,
    name: "recovery_elevation",
    checksum: "8ef3535d4485ef79a19af17ac5c111bb913bc3602bac4846ab737e5f4f8945d1",
    sql: `CREATE TABLE elevation_grants (
  id TEXT PRIMARY KEY CHECK (length(id) = 36),
...
export const supervisorMigrations = Object.freeze([
  Object.freeze({
    version: 1,
    name: "execution_hosts",
    checksum: "2700618519f4d30d14d08dc2bce893c1be73965d39eed99a635b28641835d7a6",
    sql: `CREATE TABLE schema_migrations (
  version INTEGER PRIMARY KEY CHECK (version > 0),
  name TEXT NOT NULL UNIQUE CHECK (length(name) > 0),
  checksum TEXT NOT NULL CHECK (
...
`,
  ...
  Object.freeze({
    ...
    checksum: "8b0a4c22befee148a589a1ee027025e99e7f0045437b1208a6cbfaea9ceab857",
    sql: `CREATE TABLE paired_devices (
  id TEXT PRIMARY KEY CHECK (length(id) = 36),
  display_name TEXT NOT NULL CHECK (length(display_name) > 0),
